              ...
              <form action="<?= base_url('menu/addmenu'); ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="menu_id" name="menu_id" value="<?= set_value('menu_id'); ?>" placeholder="Menu ID" autofocus autocomplete="off">
                    <?= form_error('menu_id', '<small class="text-danger pl-2">', '</small>'); ?>
                  </div>
                  <div class="form-group">
                    <label for="menu">Menu</label>
                    <input type="text" class="form-control" id="menu" name="menu" placeholder="Menu name" value="<?= set_value('menu'); ?>" autocomplete="off" autofocus>
